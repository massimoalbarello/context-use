...
Scoped guidance begins in the [backend](./packages/backend/AGENTS.md),
[frontend](./packages/frontend/AGENTS.md), and [scripts](./scripts/AGENTS.md) guides. Each guide links to
