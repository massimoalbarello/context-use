...
Scores live with their run under `eval/results/corpus/`, not in this file. A number here
would describe whichever run happened to be current when someone wrote it down, and would
then quietly misdescribe every run after that.
