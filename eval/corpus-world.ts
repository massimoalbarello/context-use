...
import { z } from "zod";
import { assembleCorpus, type Corpus, type CorpusRecord } from "./corpus-types.ts";
 ...
 * 145 questions in `qa/world-v1`. The schema below declares only the five public fields,
