...
Scores live with their run under `eval/results/`, not in this file, for the reason given
under [Reading a result](../../../runner/qa/README.md#reading-a-result): a number written
down here describes one run and then misdescribes every run after it.
