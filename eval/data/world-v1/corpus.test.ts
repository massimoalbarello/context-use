...
import { CorpusRecordReader, loadCorpus, windowRecords } from "../../runner/corpus/records.ts";
import {
  CORPUS_UPSTREAM,
  corpusDirectory,
  corpusIsUnchanged,
 ...
 * behind every question in this package's `qa/`. Both properties are asserted exactly.
 */
