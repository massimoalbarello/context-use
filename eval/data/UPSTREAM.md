...
Each `data/<id>/corpus/` directory is copied **verbatim** from
[`garrytan/gbrain-evals`][upstream] and is never edited. Context Use's loader, lockfile,
questions, answers, and scoring live beside that directory in the same evaluation package,
and are keyed by the corpus's own item slugs.
...
record body. It is the source of the 145 questions in [world-v1/qa](world-v1/qa/).
