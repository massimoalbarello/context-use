...
export function renderPublicPageDocument(
  ...
  // A page shows its own prose. Its title and summary are addressing metadata:
  // the breadcrumb carries the title, indexes carry the summary, and the
  // document head carries both for machines.
