...
function renderFootnote(lastEditedAt?: string | Date): string {
  return `<footer class="context-use-footnote">${renderLastEdited(lastEditedAt)}<p><a href="/llms.txt" type="text/plain">AI-readable site index</a>.</p><p>self-hosted with ❤️ using <a class="external-link" href="${CONTEXT_USE_URL}" target="_blank" rel="noopener noreferrer" title="External link (opens in a new tab)">context-use</a>.</p></footer>`;
}
