...
describeApplication("HTTP credential and OAuth boundary", () => {
  ...
  test("dynamic clients default to all MCP tool scopes and public clients cannot omit PKCE", async () => {
    ...
    expect(client.scope).toBe("kb:read kb:write assets:read skills:read skills:write automations:write automations:claim automations:execute");
    ...
    authorization.search = new URLSearchParams({
      ...
      response_type: "code",
      scope: "kb:read kb:write assets:read skills:read skills:write automations:write automations:claim automations:execute",
