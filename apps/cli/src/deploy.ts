...
export function remoteSecurityCommands(): string[] {
  ...
  const sql = [
    ...
    "AND (SELECT pg_get_userbyid(proowner)='context_use_projection_owner' AND prosecdef FROM pg_proc WHERE oid='project_public_markdown(text,text)'::regprocedure)",
    ...
    "AND has_function_privilege('context_use_public','project_public_markdown(text,text)','EXECUTE')",
    ...
    "AND has_function_privilege('context_use_public_mcp','project_public_markdown(text,text)','EXECUTE')",
    "AND NOT has_function_privilege('context_use_auth','project_public_markdown(text,text)','EXECUTE')",
    "AND NOT has_function_privilege('context_use_dashboard','project_public_markdown(text,text)','EXECUTE')",
    "AND NOT has_function_privilege('context_use_mcp','project_public_markdown(text,text)','EXECUTE')",
    "AND NOT has_function_privilege('context_use_storage','project_public_markdown(text,text)','EXECUTE')",
