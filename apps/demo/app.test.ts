...
import { createAuth } from '@repo/backend/lib/auth/better-auth';
...
import type {
  ...
  KnowledgePageSchema,
} from '@repo/backend/routes/api/pages/model';
import type { RecordListSchema } from '@repo/backend/routes/api/records/model';
