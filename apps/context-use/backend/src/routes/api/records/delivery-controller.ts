...
import { isUuidV7, type RecordSyncPrincipal } from '#backend/models/syncs/model.ts';
import { RecordDeliveryEnvelopeSchema } from '#backend/routes/api/records/delivery-model.generated.ts';
import type { RecordDeliveryAcceptanceContract } from '#backend/services/records/service.ts';
