...
export const Route = createFileRoute('/settings/')({
  ...
  component: McpClientsSettingsRoute,
});

function McpClientsSettingsRoute() {
  ...
  return (
    <div className="mx-auto grid w-full max-w-4xl gap-10 px-5 py-10 md:px-10 md:py-12">
      <header className="grid gap-3">
        <h1 className="font-semibold text-3xl tracking-tight">MCP clients</h1>
        <p className="max-w-3xl text-muted-foreground leading-relaxed">
          Connect apps to this knowledge base, give each client a recognizable name, and revoke
          access you no longer trust. Access tokens last five minutes. Rotated refresh credentials
          avoid routine reconnection, but a client unused for ten years must be approved again.
        </p>
      </header>
      ...
      <section className="grid gap-4" aria-labelledby="mcp-server-heading">
        <div className="grid gap-1">
          ...
          <p className="text-muted-foreground text-sm">
            Paste this Streamable HTTP URL into an app to start its secure authorization flow.
          </p>
        </div>
