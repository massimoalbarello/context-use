...
import { MAX_HYPERMEDIA_GRAPH_ANCHORS } from '#models/hypermedia-graph/model.ts';
...
import type { hypermediaNeighborhoodsResponse } from '#routes/api/hypermedia/model.ts';
...
[Temporal subject](context-use://entity/temporal-subject) uses the [feedback loop](context-use://page/growth-playbook#feedback-loop) every Friday.`,
    ...
    expect(withoutInterval.entityReferencesTruncated).toBe(false);
