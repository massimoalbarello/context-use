...
/** Result of query `FindActiveAssetImportSync`. */
export interface IFindActiveAssetImportSyncResult {
    id: string;
}

/** Result of query `InsertImportedAsset`. */
export interface IInsertImportedAssetResult {
}
...
export interface Queries {
    FindActiveAssetImportSync: IFindActiveAssetImportSyncResult;
    InsertImportedAsset: IInsertImportedAssetResult;
