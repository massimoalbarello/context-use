create table "hypermedia_search_document" (
  ...
  check ("resource_type" in ('entity', 'knowledge_page', 'asset'))
);
...
begin
  insert into "hypermedia_search_fts" (
    "rowid", "readable_id", "label", "summary", "body"
  ) values (
    new."id", new."readable_id", new."label", new."summary", new."body"
  );
end;
...
begin
  insert into "hypermedia_search_fts" (
    ...
    'delete', old."id", old."readable_id", old."label", old."summary", old."body"
  );
end;
...
create index "hypermedia_search_document_owner_type_idx"
  on "hypermedia_search_document" ("owner_id", "resource_type", "id");
