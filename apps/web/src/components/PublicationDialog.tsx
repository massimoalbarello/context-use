...
export function PublicationDialog({ page, versionNumber, publishedVersionNumber, onClose, onChanged }: {
  ...
  return <div className="modal-backdrop" role="presentation"><section className="modal" role="dialog" aria-modal="true" aria-labelledby="publication-title">
    ...
    {preview && <p className="publication-index-note">The framework will also expose the generated root and parent indexes needed to reach this page. Those indexes show the titles and summaries of folders with published descendants and explicitly published pages; private pages and folder introductions remain hidden.</p>}
