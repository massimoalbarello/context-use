...
Index the meeting where it is a material relationship milestone: for the relevant
identifiable people, and for a company when the conversation materially concerned the
owner's direct relationship with it. If a write-up relies materially on delayed memory,
say so.
