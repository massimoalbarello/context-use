...
- **`contacts`** — email, phone, handles, where they are based. Facts only.
...
`interests`, `family`, `writing`. **Add it to the list above when you use it.**
...
## Template
    ...
    **Currently:** <role> at [[companies/…|Company]] — *as of <date>*.
    ...
    ## History
    How they met and the shape of the relationship since, linking the
    [[meetings/…|meetings]] and [[events/…|events]] where it happened.
